...
These fragments are then fractionated by charge and separated by hydrophobicity in the liquid chromatography (LC) stage before being sent through tandem mass spectrometry (MS/MS).
...
After drawing the number of states per peptide $s_{ik}$, we draw the latent random censoring indicators for each censored peptide, $R_{ikl}^{mis}$.
